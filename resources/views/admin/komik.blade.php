                    ...
                    <div class="header">
                        <form action="{{ route('admin.karyastore') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control" id="judul" placeholder="Tuliskan " value="" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori" class="form-control" id="kategori">
                                    <option value="2" selected>Komik</option>
                                </select>
                                @error('kategori') <div class="small text-danger">{{ message }}</div> @enderror
                            </div>
                            <label for="">Upload File PDF</label>
                            <div class="form-group shadow">
                                <input type="file" name="file" class="dropify" data-allowed-file-extensions="pdf" accept="application/pdf, application/PDF">
                            </div>
